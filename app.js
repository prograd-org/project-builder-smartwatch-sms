...
function displaymessage() {
    ...
    if (messageclick) {
        ...
        p.innerHTML = "Java is a general purpose, high-level programming language . It is designed to have as few implementation dependencies as possible, is free to use, and can run on all platforms."
